...
export function BusinessContentSection() {
  ...
  return (
    ...
    <MotionFade>
      ...
      <section id="business-content" aria-labelledby="business-heading" className="border-b border-[#f6d199] bg-white px-4 pb-24 pt-16 sm:px-8 lg:px-40 lg:pb-[310px] lg:pt-[100px]">

        <div className="mx-auto flex max-w-[1450px] flex-col items-center gap-20 lg:gap-40">

          <div className="flex w-full flex-col-reverse items-center gap-20 lg:flex-row lg:items-center lg:justify-start lg:gap-20">

            <div className="relative w-full max-w-[370px] shrink-0 lg:order-2 lg:max-w-[742px] lg:flex-1">

              <div

                className="relative aspect-[370/282] w-full overflow-hidden rounded border border-slate-900/20 bg-white lg:aspect-[742/552]"

                dir="ltr"

              >

                <div className="absolute left-0 top-0 h-[35%] w-full rounded-t bg-[rgba(217,217,217,0.4)]" aria-hidden />

                <picture>

                  <source media="(min-width: 1024px)" srcSet={figma.beforeAfterAfter.desktop} />

                  <img

                    src={figma.beforeAfterAfter.mobile}

                    alt=""

                    className="absolute left-[38%] top-[4%] w-[60%] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] lg:left-[38%] lg:top-[2%] lg:w-[60%]"
                ...
                <picture>
                  ...
                  <source media="(min-width: 1024px)" srcSet={figma.beforeAfterScreenshot.desktop} />

                  <img

                    src={figma.beforeAfterScreenshot.mobile}

                    alt="דוגמה לפני ואחרי לכתיבת תוכן"

                    className="absolute bottom-[4%] left-[2%] w-[71%] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] lg:bottom-[4%] lg:left-[2%] lg:w-[71%]"

                  />

                </picture>

                <div className="absolute left-[14%] top-[10%] flex flex-col items-end gap-1 text-right lg:left-[18%] lg:top-[10%]">

                  <div className="flex items-center gap-2 text-[22px] text-slate-900 lg:text-[42px]">

                    <span>לפני</span>

                    <span className="inline-block h-px w-6 rotate-90 lg:w-10">

                      <img src={figma.lineVertical.desktop} alt="" className="h-full w-full" />

                    </span>

                  </div>

                  <p className="text-[6px] text-slate-900 lg:text-xs">עומס מלל וחוסר מיקוד במסר</p>

                </div>

                <div className="absolute bottom-[18%] left-[75%] flex flex-col items-start gap-1 text-right lg:bottom-[22%] lg:left-[76%]">
                  ...
                  <p className="text-[6px] text-slate-900 lg:text-xs">תוכן נקי, קריא וממוקד</p>
            ...
            <div className="flex w-full max-w-[300px] flex-col items-start gap-8 self-start text-right sm:max-w-[370px] lg:order-1 lg:max-w-[628px] lg:gap-12">
