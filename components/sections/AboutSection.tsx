          ...
          <div className="flex w-full max-w-2xl min-w-0 flex-col items-end gap-10 text-right sm:mx-auto lg:mx-0 lg:max-w-none min-[1014px]:order-2 min-[1014px]:flex-1 min-[1014px]:gap-[60px]">
            ...
            <div className="flex w-full flex-col items-center gap-10 min-[1014px]:flex-row min-[1014px]:items-center min-[1014px]:justify-between min-[1014px]:gap-20">
              ...
              <div className="order-2 flex w-full max-w-md flex-row-reverse items-center justify-center gap-2 min-[1014px]:order-1 min-[1014px]:flex-1">
                ...
                <img src={figma.laurelRight.mobile} alt="" className="h-16 w-8 shrink-0 scale-y-[-1] rotate-180 object-contain min-[1014px]:hidden" />
                <img src={figma.laurelRight.desktop} alt="" className="hidden h-[86px] w-[49px] shrink-0 scale-y-[-1] rotate-180 object-contain min-[1014px]:block" />
              </div>
            </div>
          </div>
